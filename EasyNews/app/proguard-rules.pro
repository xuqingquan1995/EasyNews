...
#与js互相调用的类
#-keepclasseswithmembers class top.xuqingquan.intelligentcommunity.ui.activity.home.WebViewActivity$AndroidAndJSInterface {
#      <methods>;
#}

#实体类
-keep class top.xuqingquan.easynews.model.entity.** {*;}
